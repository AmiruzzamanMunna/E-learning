...
<div class="container">
    ...
    <div class="card" style="margin-top: 10%">
        ...
        <div class="card-header">
            <div class="row">
                <div class="col-md-6">Exam List</div>
                <div class="col-md-1 ml-auto">
                    <!-- @if (Session::has('courseadd')) -->
                        <a href="{{route('admin.examAdd',$id)}}"><i class="fas fa-plus"></i></a> 
                    <!-- @endif -->
            ...
            <table class="table table-bordered table-responsive-md">
                <thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$key+1}}</td> 
                            <td>{{$eachdata->lecture_exam_title}}</td> 
                            <td><a href="{{route('admin.examEdit',$eachdata->lecture_exam_id)}}"><i class="fas fa-edit"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;<a onclick="return confirm('Are You Sure!!')" href="{{route('admin.deleteExam',$eachdata->lecture_exam_id)}}"><i class="fas fa-trash"></i></a></td> 
                        </tr>
                        @endforeach
