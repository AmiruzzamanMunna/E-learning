                        ...
                        <div class="col-lg-6 col-md-7 d-flex">
                            <div class="form_box">
                                ...
                                <form class="row login_form" method="post" id="contactForm" novalidate="novalidate">
                                    ...
                                    <div class="form-group col-lg-12">
                                        <input type="password" class="form-control" name="confirmpassword" id="email" placeholder="Confirm Password">
                                        <i class="fa fa-user-o"></i>
                                    </div>
                                    
                                    
                                    <div class="form-group col-lg-12">
                                        <button type="submit" value="submit" class="btn submit_btn form-control">Reset</button>
                                    </div>
